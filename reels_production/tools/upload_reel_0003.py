"""Idempotently deliver the QC-passed Reel 0003 artifact set to its Drive batch folder."""
...
REEL_DIR = ROOT / "reels" / "Reel_0003_interleaved_practice"
...
def main() -> int:
    ...
    reel_folder_id = ensure_folder("Reel_0003_interleaved_practice", batch_id)
    artifacts = [
        REEL_DIR / "reel_0003.mp4",
