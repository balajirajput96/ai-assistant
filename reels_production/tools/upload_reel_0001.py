"""Upload the verified Reel 0001 deliverables to its Drive batch folder.
...
REEL_DIR = ROOT / "reels" / "Reel_0001_retrieval_practice"
...
def main() -> int:
    ...
    reel_folder_id = ensure_folder("Reel_0001_retrieval_practice", batch_id)
    artifacts = [
        REEL_DIR / "reel_0001.mp4",
        REEL_DIR / "script_hi.md",
